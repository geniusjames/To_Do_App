...
class onBoardingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let data5 = TodoModel(title: "Mummy", description: "na so", date: "my date", time: "my time", isDone: false)
        let data6 = TodoModel(title: "Mummy Updated", description: "nil", date: "my date", time: "my time", isDone: true)
...
//        todo.createTask(task: data5)
        ...
        todo.updateTask(id: 11, updatedTask: data6)
